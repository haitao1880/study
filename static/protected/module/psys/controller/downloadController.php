...
* 摘    要: 下载统计控制器
*/
class downloadController extends PSys_AbstractController{
     ...
     *
     */
	public function trainappAction(){	    
        ...
        $PSys_DownloadModel = new PSys_DownloadModel();
        $station = $PSys_DownloadModel->GetList($where, $order, 0, 0, $field, "rha_station");
        $this->smarty->assign("station",$station['allrow']);
        $this->smarty->assign("busstation",$busstation);
        
        //左菜单锁定
        $this->smarty->assign("active_f","download/index");
        $this->smarty->assign("active","download/trainapp");
        
		$this->forward = "trainapp";
        ...
        switch($fastSearch){
            ...
            case 2://本周
                ...
                if($dataStatusFS == 1){
                    ...
                    $result = $PSys_DownloadModel->getWeek($bdate,$edate,$group,$dbname,$distinguish);
                ...
                switch($dateSearch){
                    ...
                    case "manyday":
                        ...
                        if($datastatus == 1){
                            ...
                            $result = $PSys_DownloadModel->getWeek($bdate,$edate,$group,$dbname,$distinguish,$stationChoice);
    ...
    *
    */
    public function ajaxDTrainAppChainDiagramAction(){
        ...
        switch ($fastSearch){
            ...
            case 2:
                ...
                $dbname = "rha_count_record";
                $result2 = $PSys_DownloadModel->getWeekChainDiagramDetail($id,$dbname);
                $result = $PSys_DownloadModel->getWeekChainDiagram($result2,$dbname,$distinguish,$stationChoice);
            ...
            default:
                ...
                switch ($dateSearch){
                    ...
                    case "manyweek" :
                        ...
                        $dbname = "rha_count_record";
                        $result2 = $PSys_DownloadModel->getManyWeekChainDiagramDetail($id,$dbname);
                        $result = $PSys_DownloadModel->getManyWeekChainDiagram($result2,$dbname,$distinguish,$stationChoice);
                    ...
                    case "onemonth" :
                        ...
                        $dbname = "rha_count_record";
                        $result2 = $PSys_DownloadModel->getOneMonthChainDiagramDetail($id,$dbname);
                        $result = $PSys_DownloadModel->getOneMonthChainDiagram($result2,$dbname,$distinguish,$stationChoice);
                    ...
                    case "manymonth" :
                        ...
                        $dbname = "rha_count_record";
                        $result2 = $PSys_DownloadModel->getManyMonthChainDiagramDetail($id,$dbname);
                        $result = $PSys_DownloadModel->getManyMonthChainDiagram($result2,$dbname,$distinguish,$stationChoice);
    ...
    public function ajaxOutputExcelAction(){
        ...
        case 2://本周
            ...
            if($dataStatusFS == 1){
                ...
                $Title = '下载-下载'.$word.'统计';
                $Subject = '本周-合并';
                $Description = '下载-下载'.$word.'统计(本周-合并)';
                ...
                $Title = '下载-下载'.$word.'统计';
                $Subject = '本周-比较';
                $Description = '下载-下载'.$word.'统计(本周-比较)';
                $Keywords = $Description;
                $Category = $Description;
                $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                $XPhpExcel->setSheet(0,$Subject);
        ...
        case 3://本月
            ...
            if($dataStatusFS == 1){
                ...
                $Title = '下载-下载'.$word.'统计';
                $Subject = '本月-合并';
                $Description = '下载-下载'.$word.'统计(本月-合并)';
                $Keywords = $Description;
                $Category = $Description;
                $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                $XPhpExcel->setSheet(0,$Subject);
                ...
                $Title = '下载-下载'.$word.'统计';
                $Subject = '本月-比较';
                $Description = '下载-下载'.$word.'统计(本月-比较)';
                $Keywords = $Description;
                $Category = $Description;
                $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                $XPhpExcel->setSheet(0,$Subject);
            ...
            switch($dateSearch){
                ...
                case "manyday":
                    ...
                    if($datastatus == 1){
                        ...
                        $Title = '下载-下载'.$word.'统计';
                        $Subject = '多日-合并';
                        $Description = '下载-下载'.$word.'统计(多日-合并)';
                        $Keywords = $Description;
                        $Category = $Description;
                        $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                        $XPhpExcel->setSheet(0,$Subject);
                        ...
                        $Title = '下载-下载'.$word.'统计';
                        $Subject = '多日-比较';
                        $Description = '下载-下载'.$word.'统计(多日-比较)';
                        $Keywords = $Description;
                        $Category = $Description;
                        $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                        $XPhpExcel->setSheet(0,$Subject);
...
//                        $station = $PSys_DownloadModel->GetList($where, $order, 0, 0, $field, "rha_station");
                ...
                case "oneweek":
                    ...
                    if($datastatus == 1){
                        ...
                        $Title = '下载-下载'.$word.'统计';
                        $Subject = '单周-合并';
                        $Description = '下载-下载'.$word.'统计(单周-合并)';
                        $Keywords = $Description;
                        $Category = $Description;
                        $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                        $XPhpExcel->setSheet(0,$Subject);
                        ...
                        $Title = '下载-下载'.$word.'统计';
                        $Subject = '单周-比较';
                        $Description = '下载-下载'.$word.'统计(单周-比较)';
                        $Keywords = $Description;
                        $Category = $Description;
                        $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                        $XPhpExcel->setSheet(0,$Subject);
...
//                        $station = $PSys_DownloadModel->GetList($where, $order, 0, 0, $field, "rha_station");
                ...
                case "manyweek":
                    ...
                    if($datastatus == 1){
                        ...
                        $Title = '下载-下载'.$word.'统计';
                        $Subject = '多周-合并';
                        $Description = '下载-下载'.$word.'统计(多周-合并)';
                        $Keywords = $Description;
                        $Category = $Description;
                        $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                        $XPhpExcel->setSheet(0,$Subject);
                        ...
                        $Title = '下载-下载'.$word.'统计';
                        $Subject = '多周-比较';
                        $Description = '下载-下载'.$word.'统计(多周-比较)';
                        $Keywords = $Description;
                        $Category = $Description;
                        $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                        $XPhpExcel->setSheet(0,$Subject);
                ...
                case "onemonth":
                    ...
                    if($datastatus == 1){
                        ...
                        $Title = '下载-下载'.$word.'统计';
                        $Subject = '单月-合并';
                        $Description = '下载-下载'.$word.'统计(单月-合并)';
                        $Keywords = $Description;
                        $Category = $Description;
                        $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                        $XPhpExcel->setSheet(0,$Subject);
                        ...
                        $Title = '下载-下载'.$word.'统计';
                        $Subject = '单月-比较';
                        $Description = '下载-下载'.$word.'统计(单月-比较)';
                        $Keywords = $Description;
                        $Category = $Description;
                        $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                        $XPhpExcel->setSheet(0,$Subject);
...
//                        $station = $PSys_DownloadModel->GetList($where, $order, 0, 0, $field, "rha_station");
                ...
                case "manymonth":
                    ...
                    if($datastatus == 1){
                        ...
                        $Title = '下载-下载'.$word.'统计';
                        $Subject = '多月-合并';
                        $Description = '下载-下载'.$word.'统计(多月-合并)';
                        $Keywords = $Description;
                        $Category = $Description;
                        $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                        $XPhpExcel->setSheet(0,$Subject);
                        ...
                        $Title = '下载-下载'.$word.'统计';
                        $Subject = '多月-比较';
                        $Description = '下载-下载'.$word.'统计(多月-比较)';
                        $Keywords = $Description;
                        $Category = $Description;
                        $XPhpExcel->setBasicAttr($Creator,$LastModifiedBy,$Title,$Subject,$Description,$Keywords,$Category);
                        $XPhpExcel->setSheet(0,$Subject);
