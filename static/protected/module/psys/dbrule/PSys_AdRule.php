...
* 摘    要:广告统计rule层
*/
class PSys_AdRule extends PSys_DbAbstractRule{
    /**
    *
    * 继承构造函数
    *
    ...
    public function getWeek($bdate,$edate,$group,$dbname,$distinguish,$stationChoice){
        ...
        switch($distinguish){
            ...
            case 1:
                ...
                $where = "AND model = 'ad' AND action = 'visit' AND detail = 'uv'";
                break;
                
            case 2:
                
                $where = "AND model = 'welcome' AND action = 'visit' AND detail = 'uv'";
                break;
