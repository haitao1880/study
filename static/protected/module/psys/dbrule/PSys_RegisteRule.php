...
* 摘    要:注册统计rule层
*/
class PSys_RegisteRule extends PSys_DbAbstractRule{
    /**
    *
    * 继承构造函数
    *
    ...
    public function getWeek($bdate,$edate,$group,$dbname,$distinguish,$stationChoice){
        ...
        switch($distinguish){
            ...
            case 1:
                ...
                $where = "AND model = 'register' AND action = 'visit' AND detail = 'uv'";
                break;
                
            case 2:
                
                $where = "AND model = 'register' AND action = 'login' AND detail = 'success'";
                break;
                
            case 3:
                
                $where = "AND model = 'sindex' AND action = 'visit' AND detail = 'uv'";
                break;
