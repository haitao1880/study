 ...
 *	@package	PAS2
 *
 *	$Id: DbAbstractRule.php 10 2014-06-13 07:03:39Z tony_ren $
 */
...
class DbAbstractRule
{
    ...
    {
        global $G_X;
        $this->_dbprefix = $G_X[$_dbconfig]['tb_prefix'];
        //$this->_table = $tbname;
    }
     ...
     * 通过 SQL语句获取单条记录 
    */
    public function QueryOneSql($sql,$bind=null)
    {
       return $this->GetDb()->FetchRow($sql,$bind,null);
    }
