...
$config->redirecturi='http://www.diyiyan.cc/oauth/rrcallback';
$config->APIURL		= 'http://api.renren.com/restserver.do'; //RenRen网的API调用地址，不需要修改
$config->APIKey		= '0191726af2cc4bd18efdbdb08f2fee37';	//你的API Key，请自行申请
$config->SecretKey	= 'ef305bc5807c4c639cccbd42e9d86934';	//你的API 密钥
