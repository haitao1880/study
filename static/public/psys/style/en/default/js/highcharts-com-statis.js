...
function makeChart(type,render,b_title,xv,y_title,data){
    ...
    option.plotOptions={spline: {marker: {radius: 4},dataLabels:{enabled:true,color:"#606060"},events: {click :function(e){console.log(this);chainDiagram(this.userOptions.id[e.point.index])}}},column: {marker: {radius: 4},dataLabels:{enabled:true,color:"#606060"},events: {click :function(e){console.log(this);chainDiagram(this.userOptions.id[e.point.index])}}}};
...
function chainDiagram(id){
    ...
    $.ajax({
         ...
         type: "POST",
         url: "/comprehensive/ajaxADChainDiagram",
         async: false,   
