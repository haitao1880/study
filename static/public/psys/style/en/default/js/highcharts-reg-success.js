...
function chainDiagram(id){
    ...
    $.ajax({
         ...
         type: "POST",
         url: "/registe/ajaxREGChainDiagram",
         async: false,   
...
function output(){
    ...
    window.location.href="/registe/ajaxOutputExcel?fastSearch="+$("#fastHidden").val()+"&datastatusFS="+$("input[name='datastatusFS']:checked").val()+"&dateSearch="+$("#dataSearchHidden").val()+"&oneday="+$("input[name='oneday']").val()+"&bmanyday="+$("input[name='bmanyday']").val()+"&emanyday="+$("input[name='emanyday']").val()+"&oneweek="+$("input[name='oneweek']").val()+"&bmanyweek="+$("input[name='bmanyweek']").val()+"&emanyweek="+$("input[name='emanyweek']").val()+"&onemonth="+$("input[name='onemonth']").val()+"&bmanymonth="+$("input[name='bmanymonth']").val()+"&emanymonth="+$("input[name='emanymonth']").val()+"&datastatus="+$("input[name='datastatus']:checked").val()+"&stationC="+s+"&distinguish=2";
