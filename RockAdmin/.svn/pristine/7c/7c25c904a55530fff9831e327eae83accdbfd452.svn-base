...
* 创建时间:下午4:32:20
* 字符编码:UTF-8
* 版本信息:$Id: AbstractModel.php 672 2014-07-11 07:53:38Z jing $
* 修改日期:$LastChangedDate: 2014-07-11 15:53:38 +0800 (周五, 11 七月 2014) $
* 最后版本:$LastChangedRevision: 672 $
* 修 改 者:$LastChangedBy: jing $
* 版本地址:$HeadURL: http://192.168.1.100:12000/svn/rocktrain/trunk/RockAdmin/protected/publib/abstract/AbstractModel.php $
* 摘    要:业务逻加抽象层
*/
class AbstractModel
{
