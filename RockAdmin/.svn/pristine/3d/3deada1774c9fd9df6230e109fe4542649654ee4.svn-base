...
class adsController extends Psys_AbstractController {
	...
	public function fulladsindexAction(){
		...
		$pagesize = reqnum ( "pagesize", 10 );
		$m = new Psys_AdsModel ();
		$list = $m->GetList ( ' (find_in_set(5,colid) or find_in_set(6,colid))', 'id DESC', $page, $pagesize, "id,adname,subpage,imgurl,actionurl,colid,flag" );
